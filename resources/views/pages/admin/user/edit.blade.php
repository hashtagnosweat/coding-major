                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <small>Leave this blank if you want to keep your previous password!</small>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="roles" required class="form-control">
                                            <option value="{{ $item->roles }}" selected></option>
                                            <option value="ADMIN">Admin</option>
                                            <option value="USER">User</option>
                                        </select>
                                        <small>Leave this blank if you want to keep your previous role!</
                                    </div>
                            </div>
                            <div class="row">
